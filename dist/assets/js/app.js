...
var mobmenu = (0, _jquery2.default)('.mobmenu__item');

(0, _jquery2.default)(document).ready(function () {

    /*-----------Mobile menu-----------*/
    (0, _jquery2.default)('.header__mobmenu').on('click', function () {

        (0, _jquery2.default)(this).toggleClass('header__mobmenu--active');

        if ((0, _jquery2.default)(this).hasClass('header__mobmenu--active')) {
        ...
        var elem = (0, _jquery2.default)('.menu').hasClass('menu--active');
        if (!elem) {
            (0, _jquery2.default)('.menu').addClass('menu--active');
            (0, _jquery2.default)('.menu--active').slideDown(1000);
        } else {
            if ((0, _jquery2.default)('.menu--active').is(":hidden")) {
                (0, _jquery2.default)('.menu--active').slideDown(1000);
            } else {
                (0, _jquery2.default)('.menu--active').slideUp(500);
            }
        }
    });
    ...
    function slideNext(e) {
        e.preventDefault();
        var slider = (0, _jquery2.default)('.listComment__item');
        i++;
        if (i >= slider.length) {
            i = 0;
        }
    ...
    function getIndex(e) {
        e.preventDefault();
        var logo = (0, _jquery2.default)('.listLogo__item');
        logo.removeClass('listLogo__item--active');
        logo.eq(i).addClass('listLogo__item--active');
    }

    var btnNext = (0, _jquery2.default)('.next');
    var btnPrev = (0, _jquery2.default)('.prev');
    var comment = (0, _jquery2.default)('.listComment');
    ...
    (0, _jquery2.default)(".menu__item .menu__link").on("click", function (e) {
        e.preventDefault();
        var el = (0, _jquery2.default)(this).attr("href");
        console.log((0, _jquery2.default)(el).offset().top);
        var top = (0, _jquery2.default)(el).offset().top;
        (0, _jquery2.default)('body,html').animate({ scrollTop: top }, 2000);
    });
    (0, _jquery2.default)(".button-scroll-down__link").on("click", function (e) {
        e.preventDefault();
        var button = (0, _jquery2.default)(this).attr("href");
        var btop = (0, _jquery2.default)(button).offset().top;
        (0, _jquery2.default)('body,html').animate({ scrollTop: btop }, 700);
    });
});
...
(0, _jquery2.default)(window).on('resize', function (e) {
    ...
    if (window.innerWidth > 992) {
        (0, _jquery2.default)('.menu').removeClass('menu--active').removeAttr('style');
        mobmenu.removeAttr("style");
        (0, _jquery2.default)('.header__mobmenu').removeClass('header__mobmenu--active');
    }
});
